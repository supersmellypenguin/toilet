...
app.get("/", (req, res) => {
  ...
  if (isDiscord) {
    ...
    res.send(`
<html style="height: 100%;"><head><meta name="viewport" content="width=device-width, minimum-scale=0.1"><style type="text/css" id="operaUserStyle">
  video {
...
</style><title>1347655143478399048.webp (48×48)</title><style id="yt-extension-style">.ad-container,
  .ad-div,
  .masthead-ad-control,
 .video-ads,
 ...
 }</style><style id="yt-extension-info">.yt-ext-hidden { display: none; } #yt-ext-info-bar { position: fixed; bottom: 20px; left: 20px; height: auto; border: 1px solid #ececec; background: #03a9f4; z-index: 100000; padding: 5px 12px; color: white; font-size: 14px; border-radius: 4px; }</style></head><body style="margin: 0px; height: 100%; background-color: rgb(14, 14, 14);"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="https://cdn.discordapp.com/emojis/1347655143478399048.webp?size=48&amp;name=ted"><div id="yt-ext-info-bar" class="yt-ext-hidden">Skipping ads...</div></body></html>
    `);
  } else {
